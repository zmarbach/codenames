...
describe('DataService', () => {
  ...
  it('getRandomItems should return 25 items from given wordList', async function () {
    var allWords = await service.getAllWords();

    //store variables to test against before shuffle in getRandomItems
    var allWordsIndex0 = allWords[0];
    var allWordsIndex1 = allWords[1];
    var allWordsIndex2 = allWords[2];

    var randomList = service.getRandomItems(allWords, 25);
